...
void FantasyTeam::print_details_of_the_team(string week_number)
{
    ...
    for (int k = 0; k < previous_players.size(); k++)
    {
        if (previous_players[k]->week_number == to_string(week_num))
        {
            ...
            cout << total_point << this->score << endl;
            break;
        }
    }
}
...
void FantasyTeam::make_vector_of_previous_week_players(string week_num)
{
    if (is_the_team_full())
    {
        shared_ptr<PreviousWeek> new_one = make_shared<PreviousWeek>(defender1, defender2, goal_keeper, midfielder, forward, week_num);
...
PreviousWeek::PreviousWeek(shared_ptr<Player> defender1, shared_ptr<Player> defender2, shared_ptr<Player> goal_keeper, shared_ptr<Player> midfielder, shared_ptr<Player> forward, string week_num)
{
...
void PreviousWeek::printing_goal_keeper()
{
    for (int i = 0; i < last_week_players.size(); i++)
    {
        ...
        {
            cout << str_goal_keeper << str_colon << last_week_players[i]->get_name() << endl;
        }
    }
}
...
void PreviousWeek::sort_the_defenders_for_print()
{
    ...
    cout << defender_one << defenders[0] << endl;
    cout << defender_two << defenders[1] << endl;
}
...
void PreviousWeek::printing_striker()
{
    for (int i = 0; i < last_week_players.size(); i++)
    {
        ...
        {
            cout << str_striker << last_week_players[i]->get_name() << endl;
        }
    }
}
...
void PreviousWeek::printing_midfielder()
{
    for (int i = 0; i < last_week_players.size(); i++)
    {
        ...
        {
            cout << str_midfielder << str_colon << last_week_players[i]->get_name() << endl;
        }
    }
}
