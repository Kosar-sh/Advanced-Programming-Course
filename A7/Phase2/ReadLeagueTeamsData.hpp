...
public:
    ...
    string remove_dollar_sign(string price_of_player);
    void find_the_price_and_name(string remain, string position, int start, int end, vector<shared_ptr<Player>> &players);
